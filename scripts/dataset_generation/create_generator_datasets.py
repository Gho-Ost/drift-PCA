...
def main():
    ...
    rbf = synth.ConceptDriftStream(
        stream=synth.RandomRBF(
            seed_model=23, seed_sample=23, n_classes=2, n_features=5, n_centroids=4
        ),
        drift_stream=synth.RandomRBF(
            seed_model=42, seed_sample=23, n_classes=2, n_features=5, n_centroids=4
        ),
        seed=1,
        position=2000,
        width=50,
    ...
    hyp = synth.ConceptDriftStream(
        stream=synth.Hyperplane(
            seed=23,
            n_features=5,
            n_drift_features=2, # Shouldn't matter due to mag_change=0.0
        ),
